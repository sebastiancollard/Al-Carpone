...
private:
	...
	bool tomato_mesh_loaded = false;
	bool donut_mesh_loaded = false;
	bool spike_mesh_loaded = false;
...
public:
	...
	PxRigidDynamic* createDynamicItem(Model& item_model, POWER_TYPE type, const PxTransform& t, const PxVec3& velocity);
	PxRigidDynamic* initItemPhysX(Model item_model, POWER_TYPE type);
};
...
void Primitive::createPlane(float base, float size, float uvScale)
{
...
void Primitive::createBox(float w, float h, float l)
{
...
void Primitive::createSphere(float rad, uint32_t hSegs, uint32_t vSegs)
{
